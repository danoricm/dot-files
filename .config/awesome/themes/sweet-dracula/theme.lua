-- Sweet Dracula theme for AwesomeWM

local theme = {}

theme.font          = "sans 10"

-- Sweet Dracula color palette
...
theme.wallpaper = "/home/dddyo/Github/dot-files/.config/awesome/themes/sweet-dracula/wallpaper.png"
